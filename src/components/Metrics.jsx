      ...
      <div className="bg-gray-100 dark:bg-gray-800 p-6 rounded-2xl shadow-md">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="p-4 rounded-lg bg-gray-200 dark:bg-gray-700 text-center">
            ...
            <p className="text-2xl font-bold text-blue-400">{metrics.seo}</p>
          </div>
          <div className="p-4 rounded-lg bg-gray-200 dark:bg-gray-700 text-center">
            <p className="text-sm text-gray-500">Social</p>
            <p className="text-2xl font-bold text-pink-400">{metrics.social}</p>
          </div>
          <div className="p-4 rounded-lg bg-gray-200 dark:bg-gray-700 text-center">
            <p className="text-sm text-gray-500">Performance</p>
            <p className="text-2xl font-bold text-green-400">{metrics.performance}</p>
          </div>
        </div>
      </div>
    );
